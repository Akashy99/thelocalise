...
const Footer = () => {
  ...
  <strong>Localise</strong> is a Business Consultancy Agency helping startups
  and businesses grow through registrations, licensing, compliance, and
  digital solutions.
</p>
        </div>
      ...
      <div className="footer-bottom">
        <p>
          © {new Date().getFullYear()} <strong>Localise</strong>. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
