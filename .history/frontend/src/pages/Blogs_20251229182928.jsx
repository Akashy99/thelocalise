    ...
    <div className="blogs-container">
      ...
      <div className="blogs-grid">
        ...
        <div className="blog-card">
          ...
          <h3>How to Start a Textile Business?</h3>
          <p>
          ...
          <p>
          With increasing global trade, textiles remain one of the largest and most influential sectors in the world economy.
          </p>
          <p>
          Whether you aim to enter textile manufacturing, become a retailer, or enter wholesale distribution, understanding the textile manufacturing process is essential for success.
          </p>
        </div>
      </div>
    </div>
