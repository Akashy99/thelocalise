        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p>
              ...
              Agency dedicated to helping startups, entrepreneurs, and growing
              businesses establish and scale successfully in India.
            </p>

            <p>
              We specialize in <strong>Startup Registrations</strong>, business
              licensing, government compliance, RERA & IGR services, tender
              support, and digital solutions tailored for MSMEs.
            </p>

            <p>
              Our mission is to simplify complex legal and regulatory processes
              so business owners can focus on growth while we handle compliance
          ...
          <div className="about-image">
            <img
              src="/about-us.png"
              alt="About Localise Business Consultancy"
            />
          </div>
